...
| 101 | Bad Path Format Error        | Tests that malformed path lines with invalid formats (neither standard prefix nor --no-prefix format) are properly rejected.                             | Default                 | "sanity check failed, expected"                             |
